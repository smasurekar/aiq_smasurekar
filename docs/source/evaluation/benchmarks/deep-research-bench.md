...
| Config | Description |
|--------|-------------|
| `frontends/benchmarks/deepresearch_bench/configs/config_deep_research_bench.yml` | Default: Nemotron for agent. Generates reports for submission to the official DRB evaluator. |
